...
# dataset settings
dataset_type = 'CervicalCancerPosClsDataset'  ###
...
train_pipeline = [
    ...
    dict(type='ReplaceBackgroundWrtOriRatio',
        crop_size=crop_size,
        cls_type='pos'),
...
work_dir = './work_dirs/PositiveCell/faster_rcnn_dconv_c3-c5_r50_fpn_1x_2nd_stage_update_1200x1200_bs2_scale8-16-32'
