...
train_pipeline = [
    ...
    dict(type='RandomShiftGtBBox'),
    dict(type='ReplaceBackground', crop_size=crop_size),
...
work_dir = './work_dirs/PositiveCell/faster_rcnn_dconv_c3-c5_r50_fpn_1x_2nd_stage_update_1200x1200_multi_scale4-8_bs2'
