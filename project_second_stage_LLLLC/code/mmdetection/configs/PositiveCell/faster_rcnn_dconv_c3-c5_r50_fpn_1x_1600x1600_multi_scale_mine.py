...
train_pipeline = [
    ...
    dict(type='ReplaceBackground', crop_size=image_size),
...
work_dir = './work_dirs/PositiveCell/faster_rcnn_dconv_c3-c5_r50_fpn_1x_2nd_stage_update_1600x1600_bs1_scale8-16-32-64_replace_bg'
load_from = './models/faster_rcnn_r50_fpn_1x_20181010-3d1b3351.pth'
resume_from = None
# resume_from = './work_dirs/faster_rcnn_dconv_c3-c5_r50_fpn_1x_2nd_stage_update_1600x1600_bs1/epoch_60.pth'
