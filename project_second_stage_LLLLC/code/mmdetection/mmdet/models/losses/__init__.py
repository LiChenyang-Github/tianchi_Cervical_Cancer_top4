...
from .arcface_loss import ArcFaceLoss, AngularPenaltySMLoss
...
__all__ = [
    ...
    'weight_reduce_loss', 'weighted_loss', 'ArcFaceLoss', 'AngularPenaltySMLoss', 
    'SoftCrossEntropyLoss', 'SoftFocalLoss', 
]
